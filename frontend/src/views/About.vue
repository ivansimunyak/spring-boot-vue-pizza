  ...
  <div id="wrapper">
    ...
    <div id="main">
      <p>
        ...
        pizza drove him to quit his job,<br/>
        and gave him the impetus to turn hard work and inspiration into to a
        booming online store.<br/>
        We now serve customers all over the globe, and are thrilled to be a part
